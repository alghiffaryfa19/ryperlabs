...
<div class="mdk-drawer-layout__content page">
    ...
    <div class="home-banner text-white mb-4">
        <div class="container-fluid page__container">
            <h1 class="display-4 bold" data-aos="fade-up" data-aos-duration="800">Everything you need to
                LEARN</h1>
            <p class="lead mb-5" data-aos="fade-up" data-aos-duration="1000">Get your first Job as a
                UI/UX Designer</p>
    ...
    <div class="container-fluid page__container">
                ...
                <div class="card card__course" data-aos="fade-up" data-offset="-100">
                    <div
                        ...
                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column"
                            href="#">
                            <span><img src="assets/images/logos/react.svg" class="mb-1"
            ...
            <div class="col-md-3">
                <div class="card card__course" data-aos="fade-up" data-offset="-100">
                    <div
                        ...
                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column"
                            href="#">
                            <span><img src="assets/images/logos/vuejs.svg" class="mb-1"
                                    style="width:34px;" alt="logo"></span>
            ...
            <div class="col-md-3">
                <div class="card card__course" data-aos="fade-up" data-offset="-100">
                    <div
                        ...
                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column"
                            href="#">
                            <span><img src="assets/images/logos/angular.svg" class="mb-1"
                                    style="width:34px;" alt="logo"></span>
            ...
            <div class="col-md-3">
                <div class="card card__course" data-aos="fade-up" data-offset="-100">
                    <div
                        ...
                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column"
                            href="#">
                            <span><img src="assets/images/logos/javascript.svg" class="mb-1"
                                    style="width:34px;" alt="logo"></span>
        ...
        <div class="row mb-4">
            <div class="col-md-6 d-flex align-items-center  flex-row-reverse" data-aos-duration="500"
                data-aos="fade-right">
            ...
            <div class="col-md-6 d-flex align-items-center" data-aos-duration="500"
                data-aos="fade-left">
                <div class="avatar avatar-xl mr-3">
                    <span class="bg-primary border avatar-title rounded-circle text-center text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" width="32"
                            height="32">
            ...
            <div class="row p-4">
                <div class="col-md-6 offset-md-3">
                    <div class="mb-4">
                        ...
                        <h4 class="text-center text-primary bold mb-1">Sign up and get new UI releases
                        </h4>
                        <p class="text-center text-muted">No spam. Only releases, updates and discounts
                        </p>
                    </div>
                    <div class="d-flex">

                        <input type="text" class="form-control" placeholder="Your email address">
                        <a href="#" class="btn btn-secondary ml-2" data-aos="flip-left"
                            data-aos-duration="800" data-aos-delay="150">SUBSCRIBE</a>
                    </div>
                </div>
            </div>
        </div>
